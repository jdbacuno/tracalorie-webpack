...
class CalorieTracker {
  constructor() {
    this._calorieLimit = Storage.getCalorieLimit(); // it used a static method so instantiation `new Storage()` is not needed
  ...
  _displayCaloriesProgress() {
    ...
    progressEl.style.width = `${width}%`; // or just `${percentage}`
  }
  ...
  // when clicking buttons for example, this will be called so that,
  // you won't need to refresh the browser to show the updated data
  _render() {
    this._displayCaloriesTotal();
    this._displayCaloriesConsumed();
    this._displayCaloriesBurned();
